...
module.exports = {
  ...
  cuerpo: [
    ...
    { table: {
      titulo: 'Tabla 1. Población de Lambayeque según nivel socioeconómico, 2026',
    ...
    { table: {
      ...
      head: ['', ...años],
      rows: [['Población objetivo proyectada', '160 402', '160 020', '159 639', '159 259', '158 879', '158 501', '158 123']],
