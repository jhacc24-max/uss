...
module.exports = {
  ...
  cuerpo: [
    ...
    { table: {
      ...
      fuente: 'Fuente: INEI – ENAHO 2024, en GRTPE–OSEL Lambayeque, Mercado laboral de los jóvenes en la región Lambayeque (2025), p. 56; NSE, CPI. Elaboración propia para las dos últimas filas.',
    } },
    ...
    { table: {
      ...
      head: ['', ...años],
      rows: [['Población objetivo proyectada', '110 938', '110 674', '110 410', '110 147', '109 885', '109 623', '109 362']],
    ...
    { table: {
      ...
      rows: [
        ...
        ['Privada', 'USAT, UCV y USMP (filial Chiclayo)', 'Licenciadas', `No identificada ${V}`],
    ...
    { p: 'Aun con el escenario conservador (1 % de interés) y tomando como oferta regional el total nacional de ingresantes de la UTP, para 2027 habría una brecha de alrededor de 870 jóvenes interesados en estudiar Farmacia y Bioquímica que no encontrarían una vacante en una universidad licenciada de la región. En el escenario medio, la brecha se acerca a los 2 000 jóvenes por año.' },
