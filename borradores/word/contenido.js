...
module.exports = {
  ...
  cuerpo: [
    ...
    { p: `La viabilidad final depende de completar el estudio de demanda (Tablas 1-4 y 6) y la confirmación de la inversión en laboratorios y de la plana docente ${P}.` },
